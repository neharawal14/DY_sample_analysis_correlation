...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   public:
    ...
    TString saving_path = "/afs/cern.ch/user/n/nrawal/work/DY_analysis/programs_DSCB/plots_pt_tmp/";
   ...
   TH1D * hist_Zmass_negative_1stbin = new TH1D("hist_Zmass_negative_1stbin"," Gen Z mass for  #mu^{-} between 0 and 15 GeV",600,60,120); 
    ...
    TH1D * hist_Zmass_negative_1st_etabin = new TH1D("hist_Zmass_negative_1st_etabin"," Gen Z mass for 0 #leq #eta < 0.6",480,60,120); 
    TH1D * hist_Zmass_negative_2nd_etabin = new TH1D("hist_Zmass_negative_2nd_etabin"," Gen Z mass for 0.6 #leq #eta < 1.2",480,60,120); 
    TH1D * hist_Zmass_negative_3rd_etabin = new TH1D("hist_Zmass_negative_3rd_etabin"," Gen Z mass for 1.2 #leq #eta < 1.8",480,60,120); 
    TH1D * hist_Zmass_negative_4th_etabin = new TH1D("hist_Zmass_negative_4th_etabin"," Gen Z mass for 1.8 #leq #eta #leq 2.4",480,60,120); 
    TH1D * hist_Zmass_negative_5th_etabin = new TH1D("hist_Zmass_negative_5th_etabin"," Gen Z mass for -2.4 #leq #eta < -1.8",480,60,120); 
    TH1D * hist_Zmass_negative_6th_etabin = new TH1D("hist_Zmass_negative_6th_etabin"," Gen Z mass for -1.8 #leq #eta < -1.2",480,60,120); 
    TH1D * hist_Zmass_negative_7th_etabin = new TH1D("hist_Zmass_negative_7th_etabin"," Gen Z mass for -1.2 #leq #eta < -0.6",480,60,120); 
    TH1D * hist_Zmass_negative_8th_etabin = new TH1D("hist_Zmass_negative_8th_etabin"," Gen Z mass for -0.6 #leq #eta < 0",480,60,120); 

    TH1D * hist_Zmass_positive_1st_etabin = new TH1D("hist_Zmass_positive_1st_etabin"," Gen Z mass for 0 #leq #eta < 0.6",480,60,120); 
    TH1D * hist_Zmass_positive_2nd_etabin = new TH1D("hist_Zmass_positive_2nd_etabin"," Gen Z mass for 0.6 #leq #eta < 1.2",480,60,120); 
    TH1D * hist_Zmass_positive_3rd_etabin = new TH1D("hist_Zmass_positive_3rd_etabin"," Gen Z mass for 1.2 #leq #eta < 1.8",480,60,120); 
    TH1D * hist_Zmass_positive_4th_etabin = new TH1D("hist_Zmass_positive_4th_etabin"," Gen Z mass for 1.8 #leq #eta #leq 2.4",480,60,120); 
    TH1D * hist_Zmass_positive_5th_etabin = new TH1D("hist_Zmass_positive_5th_etabin"," Gen Z mass for -2.4 #leq #eta < -1.8",480,60,120); 
    TH1D * hist_Zmass_positive_6th_etabin = new TH1D("hist_Zmass_positive_6th_etabin"," Gen Z mass for -1.8 #leq #eta < -1.2",480,60,120); 
    TH1D * hist_Zmass_positive_7th_etabin = new TH1D("hist_Zmass_positive_7th_etabin"," Gen Z mass for -1.2 #leq #eta < -0.6",480,60,120); 
    TH1D * hist_Zmass_positive_8th_etabin = new TH1D("hist_Zmass_positive_8th_etabin"," Gen Z mass for -0.6 #leq #eta < 0",480,60,120); 

    TH1D * hist_Zmass_negative_1st_phibin = new TH1D("hist_Zmass_negative_1st_phibin"," Gen Z mass for 0 #leq #phi < 0.6",480,60,120); 
    TH1D * hist_Zmass_negative_2nd_phibin = new TH1D("hist_Zmass_negative_2nd_phibin"," Gen Z mass for 0.6 #leq #phi < 1.2",480,60,120); 
    TH1D * hist_Zmass_negative_3rd_phibin = new TH1D("hist_Zmass_negative_3rd_phibin"," Gen Z mass for 1.2 #leq #phi < 1.8",480,60,120); 
    TH1D * hist_Zmass_negative_4th_phibin = new TH1D("hist_Zmass_negative_4th_phibin"," Gen Z mass for 1.8 #leq #phi #leq 2.4",480,60,120); 
    TH1D * hist_Zmass_negative_5th_phibin = new TH1D("hist_Zmass_negative_5th_phibin"," Gen Z mass for -2.4 #leq #phi < -1.8",480,60,120); 
    TH1D * hist_Zmass_negative_6th_phibin = new TH1D("hist_Zmass_negative_6th_phibin"," Gen Z mass for -1.8 #leq #phi < -1.2",480,60,120); 
    TH1D * hist_Zmass_negative_7th_phibin = new TH1D("hist_Zmass_negative_7th_phibin"," Gen Z mass for -1.2 #leq #phi < -0.6",480,60,120); 
    TH1D * hist_Zmass_negative_8th_phibin = new TH1D("hist_Zmass_negative_8th_phibin"," Gen Z mass for -0.6 #leq #phi < 0",480,60,120); 

    TH1D * hist_Zmass_positive_1st_phibin = new TH1D("hist_Zmass_positive_1st_phibin"," Gen Z mass for 0 #leq #phi < 0.6",480,60,120); 
    TH1D * hist_Zmass_positive_2nd_phibin = new TH1D("hist_Zmass_positive_2nd_phibin"," Gen Z mass for 0.6 #leq #phi < 1.2",480,60,120); 
    TH1D * hist_Zmass_positive_3rd_phibin = new TH1D("hist_Zmass_positive_3rd_phibin"," Gen Z mass for 1.2 #leq #phi < 1.8",480,60,120); 
    TH1D * hist_Zmass_positive_4th_phibin = new TH1D("hist_Zmass_positive_4th_phibin"," Gen Z mass for 1.8 #leq #phi #leq 2.4",480,60,120); 
    TH1D * hist_Zmass_positive_5th_phibin = new TH1D("hist_Zmass_positive_5th_phibin"," Gen Z mass for -2.4 #leq #phi < -1.8",480,60,120); 
    TH1D * hist_Zmass_positive_6th_phibin = new TH1D("hist_Zmass_positive_6th_phibin"," Gen Z mass for -1.8 #leq #phi < -1.2",480,60,120); 
    TH1D * hist_Zmass_positive_7th_phibin = new TH1D("hist_Zmass_positive_7th_phibin"," Gen Z mass for -1.2 #leq #phi < -0.6",480,60,120); 
    TH1D * hist_Zmass_positive_8th_phibin = new TH1D("hist_Zmass_positive_8th_phibin"," Gen Z mass for -0.6 #leq #phi < 0",480,60,120); 
  ...
  // Fit the mass into DSCB
    ...
    RooRealVar AlphaL("#alpha_{L}", "#alpha_{L}", 10, 0.1, 30);//alphaL[decay]);
    RooRealVar ExpL("n_{L}", "n_{L}", 20, 0.1, 30);//expL[decay]);
    RooRealVar AlphaR("#alpha_{R}", "#alpha_{R}", 10, 0.1, 30);//alphaR[decay]);
    RooRealVar ExpR("n_{R}", "n_{R}", 20, 0.1, 30);//expR[decay]);
