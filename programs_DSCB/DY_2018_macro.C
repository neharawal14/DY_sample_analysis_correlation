...
//end of loop of entries   
  ...
  mean_sigma_negative_eta[1] = plotting_fitting_mass_DSCB(hist_Zmass_negative_2nd_etabin,"Zmass_2ndbin_eta_fit_negative");
   ...
   if(analyze_phi==true){
   mean_sigma_positive_phi[0] =  plotting_fitting_mass_DSCB(hist_Zmass_positive_1st_phibin,"Zmass_1stbin_phi_fit_positive");
   mean_sigma_positive_phi[1] = plotting_fitting_mass_DSCB(hist_Zmass_positive_2nd_phibin,"Zmass_2ndbin_phi_fit_positive");
   mean_sigma_positive_phi[2] = plotting_fitting_mass_DSCB(hist_Zmass_positive_3rd_phibin,"Zmass_3rdbin_phi_fit_positive");
   mean_sigma_positive_phi[3] = plotting_fitting_mass_DSCB(hist_Zmass_positive_4th_phibin,"Zmass_4thbin_phi_fit_positive");
   mean_sigma_positive_phi[4] = plotting_fitting_mass_DSCB(hist_Zmass_positive_5th_phibin,"Zmass_5thbin_phi_fit_positive");
   mean_sigma_positive_phi[5] = plotting_fitting_mass_DSCB(hist_Zmass_positive_6th_phibin,"Zmass_6thbin_phi_fit_positive");
   mean_sigma_positive_phi[6] = plotting_fitting_mass_DSCB(hist_Zmass_positive_7th_phibin,"Zmass_7thbin_phi_fit_positive");
   mean_sigma_positive_phi[7] = plotting_fitting_mass_DSCB(hist_Zmass_positive_8th_phibin,"Zmass_8thbin_phi_fit_positive");
 
   mean_sigma_negative_phi[0] =  plotting_fitting_mass_DSCB(hist_Zmass_negative_1st_phibin,"Zmass_1stbin_phi_fit_negative");
   mean_sigma_negative_phi[1] = plotting_fitting_mass_DSCB(hist_Zmass_negative_2nd_phibin,"Zmass_2ndbin_phi_fit_negative");
   mean_sigma_negative_phi[2] = plotting_fitting_mass_DSCB(hist_Zmass_negative_3rd_phibin,"Zmass_3rdbin_phi_fit_negative");
   mean_sigma_negative_phi[3] = plotting_fitting_mass_DSCB(hist_Zmass_negative_4th_phibin,"Zmass_4thbin_phi_fit_negative");
   mean_sigma_negative_phi[4] = plotting_fitting_mass_DSCB(hist_Zmass_negative_5th_phibin,"Zmass_5thbin_phi_fit_negative");
   mean_sigma_negative_phi[5] = plotting_fitting_mass_DSCB(hist_Zmass_negative_6th_phibin,"Zmass_6thbin_phi_fit_negative");
   mean_sigma_negative_phi[6] = plotting_fitting_mass_DSCB(hist_Zmass_negative_7th_phibin,"Zmass_7thbin_phi_fit_negative");
   mean_sigma_negative_phi[7] = plotting_fitting_mass_DSCB(hist_Zmass_negative_8th_phibin,"Zmass_8thbin_phi_fit_negative");
