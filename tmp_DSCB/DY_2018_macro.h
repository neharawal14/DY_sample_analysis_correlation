...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   public:
    ...
    TString saving_path = "/afs/cern.ch/user/n/nrawal/work/DY_analysis/tmp_DSCB/plots_eta/";
  ...
  // Fit the mass into DSCB
    ...
    RooMyPDF_DSCB DSCB("DSCB", "DSCB", m4mu, Mean, Sigma, AlphaL, ExpL, AlphaR, ExpR);
     ...
     RooBreitWigner BW("BW","Breit Wigner fit",m4mu, mean_mass,width);
...
//    histo.statOn(xframe);
    ...
    BW.fitTo(histo,Range(70,110));
    BW.plotOn(xframe,RooFit::LineColor(kBlue));
    BW.paramOn(xframe,RooFit::Layout(0.6,0.7,0.4));
