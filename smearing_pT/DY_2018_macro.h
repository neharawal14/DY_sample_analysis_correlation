...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   public:
    ...
    TString saving_path = "/afs/cern.ch/user/n/nrawal/work/DY_analysis/smearing_pT/plots_eta/";
    double pt_list_mean[10] = {7.5,22.5,35,45,55,65,82.5,100,120,165};
    double pt_list[11] = {0,15,30,40,50,60,75,90,110,130,200};
    double eta_list_mean[8] = {-2.1,-1.5,-0.9,-0.3,0.3,0.9,1.5,2.1}; 
    double eta_list[9] = {-2.4,-1.8,-1.2,-0.6,0,0.6,1.2,1.8,2.4};
    double phi_list_mean[8] = {-7*pi/8,-5*pi/8,-3*pi/8,-pi/8,pi/8,3*pi/8,5*pi/8,7*pi/8}; 
    double phi_list[9] = {-pi, -3*pi/4, -pi/2, -pi/4, 0 , pi/4, pi/2, 3*pi/4, pi};

    TString bin_number[8] = {"1st","2nd","3rd","4th","5th","6th","7th","8th"};
   ...
   /* 
    TH1D * hist_Zmass_positive_1stbin = new TH1D("hist_Zmass_positive_1stbin"," Gen Z mass for  #mu^{+} between 0 and 15 GeV",600,60,120); 
    TH1D * hist_Zmass_positive_2ndbin = new TH1D("hist_Zmass_positive_2ndbin"," Gen Z mass for  #mu^{+} between 15 and 30 GeV",600,60,120); 
    TH1D * hist_Zmass_positive_3rdbin = new TH1D("hist_Zmass_positive_3rdbin"," Gen Z mass for  #mu^{+} between 30 and 40 GeV",600,60,120); 
    TH1D * hist_Zmass_positive_4thbin = new TH1D("hist_Zmass_positive_4thbin"," Gen Z mass for  #mu^{+} between 40 and 50 GeV",600,60,120); 
    TH1D * hist_Zmass_positive_5thbin = new TH1D("hist_Zmass_positive_5thbin"," Gen Z mass for  #mu^{+} between 50 and 60 GeV",600,60,120); 
    TH1D * hist_Zmass_positive_6thbin = new TH1D("hist_Zmass_positive_6thbin"," Gen Z mass for  #mu^{+} between 60 and 75 GeV",600,60,120); 
    TH1D * hist_Zmass_positive_7thbin = new TH1D("hist_Zmass_positive_7thbin"," Gen Z mass for  #mu^{+} between 75 and 90 GeV",600,60,120); 
    TH1D * hist_Zmass_positive_8thbin = new TH1D("hist_Zmass_positive_8thbin"," Gen Z mass for  #mu^{+} between 90 and 110 GeV",600,60,120); 
    TH1D * hist_Zmass_positive_9thbin = new TH1D("hist_Zmass_positive_9thbin"," Gen Z mass for  #mu^{+} between 110 and 130 GeV",600,60,120); 
    TH1D * hist_Zmass_positive_10thbin = new TH1D("hist_Zmass_positive_10thbin"," Gen Z mass for  #mu^{+} between 130 and 200 GeV",600,60,120); 

   TH1D * hist_Zmass_negative_1stbin = new TH1D("hist_Zmass_negative_1stbin"," Gen Z mass for  #mu^{-} between 0 and 15 GeV",600,60,120); 
    TH1D * hist_Zmass_negative_2ndbin = new TH1D("hist_Zmass_negative_2ndbin"," Gen Z mass for  #mu^{-} between 15 and 30 GeV",600,60,120); 
    TH1D * hist_Zmass_negative_3rdbin = new TH1D("hist_Zmass_negative_3rdbin"," Gen Z mass for  #mu^{-} between 30 and 40 GeV",600,60,120); 
    TH1D * hist_Zmass_negative_4thbin = new TH1D("hist_Zmass_negative_4thbin"," Gen Z mass for  #mu^{-} between 40 and 50 GeV",600,60,120); 
    TH1D * hist_Zmass_negative_5thbin = new TH1D("hist_Zmass_negative_5thbin"," Gen Z mass for  #mu^{-} between 50 and 60 GeV",600,60,120); 
    TH1D * hist_Zmass_negative_6thbin = new TH1D("hist_Zmass_negative_6thbin"," Gen Z mass for  #mu^{-} between 60 and 75 GeV",600,60,120); 
    TH1D * hist_Zmass_negative_7thbin = new TH1D("hist_Zmass_negative_7thbin"," Gen Z mass for  #mu^{-} between 75 and 90 GeV",600,60,120); 
    TH1D * hist_Zmass_negative_8thbin = new TH1D("hist_Zmass_negative_8thbin"," Gen Z mass for  #mu^{-} between 90 and 110 GeV",600,60,120); 
    TH1D * hist_Zmass_negative_9thbin = new TH1D("hist_Zmass_negative_9thbin"," Gen Z mass for  #mu^{-} between 110 and 130 GeV",600,60,120); 
    TH1D * hist_Zmass_negative_10thbin = new TH1D("hist_Zmass_negative_10thbin"," Gen Z mass for  #mu^{-} between 130 and 200 GeV",600,60,120); 

    TH1D * hist_reco_Zmass_positive_1stbin = new TH1D("hist_reco_Zmass_positive_1stbin"," Reco Z mass for  #mu^{+} between 0 and 15 GeV",600,60,120); 
    TH1D * hist_reco_Zmass_positive_2ndbin = new TH1D("hist_reco_Zmass_positive_2ndbin"," Reco Z mass for  #mu^{+} between 15 and 30 GeV",600,60,120); 
    TH1D * hist_reco_Zmass_positive_3rdbin = new TH1D("hist_reco_Zmass_positive_3rdbin"," Reco Z mass for  #mu^{+} between 30 and 40 GeV",600,60,120); 
    TH1D * hist_reco_Zmass_positive_4thbin = new TH1D("hist_reco_Zmass_positive_4thbin"," Reco Z mass for  #mu^{+} between 40 and 50 GeV",600,60,120); 
    TH1D * hist_reco_Zmass_positive_5thbin = new TH1D("hist_reco_Zmass_positive_5thbin"," Reco Z mass for  #mu^{+} between 50 and 60 GeV",600,60,120); 
    TH1D * hist_reco_Zmass_positive_6thbin = new TH1D("hist_reco_Zmass_positive_6thbin"," Reco Z mass for  #mu^{+} between 60 and 75 GeV",600,60,120); 
    TH1D * hist_reco_Zmass_positive_7thbin = new TH1D("hist_reco_Zmass_positive_7thbin"," Reco Z mass for  #mu^{+} between 75 and 90 GeV",600,60,120); 
    TH1D * hist_reco_Zmass_positive_8thbin = new TH1D("hist_reco_Zmass_positive_8thbin"," Reco Z mass for  #mu^{+} between 90 and 110 GeV",600,60,120); 
    TH1D * hist_reco_Zmass_positive_9thbin = new TH1D("hist_reco_Zmass_positive_9thbin"," Reco Z mass for  #mu^{+} between 110 and 130 GeV",600,60,120); 
    TH1D * hist_reco_Zmass_positive_10thbin = new TH1D("hist_reco_Zmass_positive_10thbin"," Reco Z mass for  #mu^{+} between 130 and 200 GeV",600,60,120); 

    TH1D * hist_reco_Zmass_negative_1stbin = new TH1D("hist_reco_Zmass_negative_1stbin"," Reco Z mass for  #mu^{+} between 0 and 15 GeV",600,60,120); 
    TH1D * hist_reco_Zmass_negative_2ndbin = new TH1D("hist_reco_Zmass_negative_2ndbin"," Reco Z mass for  #mu^{+} between 15 and 30 GeV",600,60,120); 
    TH1D * hist_reco_Zmass_negative_3rdbin = new TH1D("hist_reco_Zmass_negative_3rdbin"," Reco Z mass for  #mu^{+} between 30 and 40 GeV",600,60,120); 
    TH1D * hist_reco_Zmass_negative_4thbin = new TH1D("hist_reco_Zmass_negative_4thbin"," Reco Z mass for  #mu^{+} between 40 and 50 GeV",600,60,120); 
    TH1D * hist_reco_Zmass_negative_5thbin = new TH1D("hist_reco_Zmass_negative_5thbin"," Reco Z mass for  #mu^{+} between 50 and 60 GeV",600,60,120); 
    TH1D * hist_reco_Zmass_negative_6thbin = new TH1D("hist_reco_Zmass_negative_6thbin"," Reco Z mass for  #mu^{+} between 60 and 75 GeV",600,60,120); 
    TH1D * hist_reco_Zmass_negative_7thbin = new TH1D("hist_reco_Zmass_negative_7thbin"," Reco Z mass for  #mu^{+} between 75 and 90 GeV",600,60,120); 
    TH1D * hist_reco_Zmass_negative_8thbin = new TH1D("hist_reco_Zmass_negative_8thbin"," Reco Z mass for  #mu^{+} between 90 and 110 GeV",600,60,120); 
    TH1D * hist_reco_Zmass_negative_9thbin = new TH1D("hist_reco_Zmass_negative_9thbin"," Reco Z mass for  #mu^{+} between 110 and 130 GeV",600,60,120); 
    TH1D * hist_reco_Zmass_negative_10thbin = new TH1D("hist_reco_Zmass_negative_10thbin"," Reco Z mass for  #mu^{+} between 130 and 200 GeV",600,60,120); 
...
*/
    ...
    TH1D * hist_gen_pT1_smear = new TH1D("hist_gen_pT1_smear", " Gen pT of first lepton after smearing " , 400,0,200);
    TH1D * hist_gen_pT2_smear = new TH1D("hist_gen_pT2_smear", " Gen pT of second lepton after smearing " , 400,0,200);
    ...
    TH1D * hist_gen_Zmass_smear = new TH1D("hist_gen_Zmass_smear"," Gen Z mass after smearing",300,60,120); 
    
    TH1D * hist_gen_positive_mu_smear = new TH1D("hist_gen_positive_mu_smear", " Gen pT (#mu^{+}) after smearing " , 400,0,200);
    TH1D * hist_id_positive_mu_smear = new TH1D("hist_id_positive_mu_smear", " id (#mu^{+}) after smearing " , 15,0,15);
   
    TH1D * hist_gen_negative_mu_smear = new TH1D("hist_gen_negative_mu_smear", " Gen pT (#mu^{-}) after smearing " , 400,0,200);
    TH1D * hist_id_negative_mu_smear = new TH1D("hist_id_negative_mu_smear", " id (#mu^{-}) after smearing " , 15,-15,0);
  
    TH1D * hist_reco_Zmass = new TH1D("hist_reco_Zmass", " m(#mu^{-} #mu^{-}) after smearing " , 300,60,120);


    // new declaration of histograms
     ...
     TH1D *histogram_Zmass_positive_eta[8];
     TH1D *histogram_Zmass_negative_eta[8];
     TH1D *histogram_Zmass_positive_phi[8];
     TH1D *histogram_Zmass_negative_phi[8];
    ...
    void histogram_declaration_eta();
    void histogram_declaration_phi();
    ...
    void histogram_filling_positive_eta(int i);
    void histogram_filling_negative_eta(int i);
    void histogram_filling_positive_phi(int i);
    void histogram_filling_negative_phi(int i);
};
  ...
  void DY_2018_macro :: histogram_declaration_pt(){
   ...
   TString title_positive = TString::Format("Gen Z mass for  #mu^{+} : %.0f  #leq pT < %.0f" ,pt_list[i], pt_list[i+1]) ; 
   histogram_Zmass_positive_pt[i] = new TH1D(histogram_name_positive,title_positive, 300,60,120);
   }
   for(int i=0;i<8;i++){
    TString histogram_name_negative = TString::Format("histogram_Zmass_negative_pt[%d]",i);
    TString title_negative = TString::Format("Gen Z mass for  #mu^{-} : %.0f  #leq pT < %.0f" ,pt_list[i], pt_list[i+1]) ; 
    histogram_Zmass_negative_pt[i] = new TH1D(histogram_name_negative,title_negative, 300,60,120);
   }
  }
  ...
  void DY_2018_macro :: histogram_declaration_pt_smear(){
   ...
   histogram_Zmass_positive_pt_smear[i] = new TH1D(histogram_name_positive,title_positive, 300,60,120);
   }
   for(int i=0;i<8;i++){
    ...
    histogram_Zmass_negative_pt_smear[i] = new TH1D(histogram_name_negative,title_negative, 300,60,120);
   }
  }
 ...
 // eta 
  void DY_2018_macro :: histogram_declaration_eta(){
   for(int i=0; i<8;i++)
   {
    TString histogram_name_positive = TString::Format("histogram_Zmass_positive_eta[%d]",i);
 //  string title_positive_str = "Gen Z mass for  #mu^{+} : " +  std::to_string(eta_list[i]) + "#leq #eta < "+ std::to_string(eta_list[i+1]) ; 
   TString title_positive = TString::Format("Gen Z mass for  #mu^{+} : %0.1f  #leq #eta < %0.1f" ,eta_list[i], eta_list[i+1]) ; 
//    TString title_positive(title_positive_str);  
   histogram_Zmass_positive_eta[i] = new TH1D(histogram_name_positive,title_positive, 300,60,120);
   }
   for(int i=0;i<8;i++){
    TString histogram_name_negative = TString::Format("histogram_Zmass_negative_eta[%d]",i);
   TString title_negative = TString::Format("Gen Z mass for  #mu^{-} : %0.1f  #leq #eta < %0.1f" ,eta_list[i], eta_list[i+1]) ; 
  //  string title_negative_str = "Gen Z mass for  #mu^{-} : " +  std::to_string(eta_list[i]) + "#leq #eta < "+ std::to_string(eta_list[i+1]) ; 
   // TString title_negative(title_negative_str);  
    histogram_Zmass_negative_eta[i] = new TH1D(histogram_name_negative,title_negative, 300,60,120);
   }
  }


  void DY_2018_macro :: histogram_filling_positive_eta(int i){
   histogram_Zmass_positive_eta[i]->Fill(GENmass2l); 
  } 

  void DY_2018_macro :: histogram_filling_negative_eta(int i){
   histogram_Zmass_negative_eta[i]->Fill(GENmass2l); 
  } 


 // phi 
  void DY_2018_macro :: histogram_declaration_phi(){
   for(int i=0; i<8;i++)
   {
    TString histogram_name_positive = TString::Format("histogram_Zmass_positive_phi[%d]",i);
   TString title_positive = TString::Format("Gen Z mass for  #mu^{+} : %0.0f  #leq #phi < %0.0f" ,phi_list[i], phi_list[i+1]) ; 
   histogram_Zmass_positive_phi[i] = new TH1D(histogram_name_positive,title_positive, 300,60,120);
   }
   for(int i=0;i<8;i++){
    TString histogram_name_negative = TString::Format("histogram_Zmass_negative_phi[%d]",i);
   TString title_negative = TString::Format("Gen Z mass for  #mu^{-} : %0.0f  #leq #phi < %0.0f" ,phi_list[i], phi_list[i+1]) ; 
    histogram_Zmass_negative_phi[i] = new TH1D(histogram_name_negative,title_negative, 300,60,120);
   }
  }


  void DY_2018_macro :: histogram_filling_positive_phi(int i){
   histogram_Zmass_positive_phi[i]->Fill(GENmass2l); 
  } 

  void DY_2018_macro :: histogram_filling_negative_phi(int i){
   histogram_Zmass_negative_phi[i]->Fill(GENmass2l); 
  } 
 ...
 void DY_2018_macro :: graph_diff_Zmass_gen_reco(){
   ...
   // TGraph *gr = new TGraph(10,pT_list,mean);
   gr_diff_gen_reco_positive->GetYaxis()->SetTitle("mass_{(#mu^{+}#mu^{-})}");
   gr_diff_gen_reco_positive->GetXaxis()->SetTitle("pT (GeV)");
   gr_diff_gen_reco_positive->SetTitle("#mu^{+}");
   TCanvas *graph_canvas = new TCanvas("graph_canvas","diff Gen and Reco Z mass");
   graph_canvas->cd(); 
   
   gr_diff_gen_reco_positive->Draw("AP*");
   graph_canvas->SaveAs(saving_path+"diff_Zmass_positive_gen_reco.pdf"); 
 
   TGraph *gr_diff_gen_reco_negative = new TGraph(10, pt_list_mean,diff_Zmass_negative_gen_reco);
   // TGraph *gr = new TGraph(10,pT_list,mean);
   gr_diff_gen_reco_negative->GetYaxis()->SetTitle("mass_{(#mu^{+}#mu^{-})}");
   gr_diff_gen_reco_negative->GetXaxis()->SetTitle("pT (GeV)");
   gr_diff_gen_reco_negative->SetTitle("#mu^{+}");
   TCanvas *graph_canvas_1 = new TCanvas("graph_canvas_1","diff Gen and Reco Z mass");
   graph_canvas_1->cd(); 
   
   gr_diff_gen_reco_negative->Draw("AP*");
   graph_canvas_1->SaveAs(saving_path+"diff_Zmass_negative_gen_reco.pdf"); 
 
 }

   void DY_2018_macro :: graph_mean_eta(){
   TGraphErrors *gr_positive = new TGraphErrors(8, eta_list_mean,mean_positive_eta, 0,sigma_positive_eta);
   // TGraph *gr = new TGraph(10,pT_list,mean);
   gr_positive->GetYaxis()->SetTitle("mass_{(#mu^{+}#mu^{-})}");
   ...
   TGraphErrors *gr_negative = new TGraphErrors(8, eta_list_mean,mean_negative_eta, 0,sigma_negative_eta);
   // TGraph *gr = new TGraph(10,pT_list,mean);
   gr_negative->GetYaxis()->SetTitle("mass_{(#mu^{+}#mu^{-})}");
...
//     histo.statOn(xframe);
  ...
  // Fit the mass into DSCB
    ...
    RooRealVar ExpL("n_{L}", "n_{L}", 0.5, 2.0, 30);//expL[decay]);
    RooRealVar AlphaR("#alpha_{R}", "#alpha_{R}", 0.6, 0.1, 30);//alphaR[decay]);
    RooRealVar ExpR("n_{R}", "n_{R}", 0.5, 2.5, 30);//expR[decay]);
...
void DY_2018_macro :: smearing_pT(){
 double smear_value = 0.025; 
 genLep_pt1 = genLep_pt1 * (1+smear_value);
 genLep_pt2 = genLep_pt2 * (1+smear_value);
}
...
void DY_2018_macro::Init(TTree *tree)
{
   ...
   //this->histogram_declaration_pt();
  // this->histogram_declaration_eta();
  // this->histogram_declaration_phi();
  // this->histogram_declaration_pt_smear();
