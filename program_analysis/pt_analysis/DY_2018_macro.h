...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   public:
    ...
    TString saving_path = "/afs/cern.ch/user/n/nrawal/work/DY_analysis/program_analysis/pt_analysis/plots_tmp/";
    ...
    void histogram_pt_distiribtution();
    ...
    void DY_2018_macro :: histogram_pt_distiribtution(){
     for(int i= 0;i<10; i++){
 ...
 void DY_2018_macro :: graph_diff_Zmass_gen_reco(){
   ...
   gr_diff_gen_reco_positive->GetYaxis()->SetRangeUser(-0.003,0.003);
   ...
   gr_diff_gen_reco_negative->GetYaxis()->SetRangeUser(-0.003,0.003);
...
void DY_2018_macro :: saving_histograms(){

}
void DY_2018_macro :: smearing_pT(){
  
 smear_value1 = random->Gaus(0,0.025*genLep_pt1);
 smear_value2 = random->Gaus(0,0.025*genLep_pt2);
...
void DY_2018_macro :: total_entries(){
  ...
  total_entries_negative_smear = n_negative_bin_smear[i] + total_entries_negative_smear;
   ...
   if(debug_entries == true){
    ...
    myfile_n_entries<<"total number of entries above 200 GeV before smearing #mu^{+} "<<count_positive_mue<<std::endl;
...
void DY_2018_macro :: plot_entries(){
  ...
  gr_positive_entries->Draw("AB");
  canvas_entries_positive->cd(2);
  gr_positive_entries_smear->Draw("AB");
  ...
  gr_negative_entries->Draw("AB");
  canvas_entries_negative->cd(2);
  gr_negative_entries_smear->Draw("AB");
