      ...
      if(Id1==13)    
      {
       ...
       if(analyze_pT == true){
        if(0<= genLep_pt1 && genLep_pt1 < 15) {
         ...
         if(smearing== true) hist_reco_Zmass_positive_1stbin->Fill(massZ_reconstruct);
         }

        if(15 <= genLep_pt1  && genLep_pt1 < 30) {
         hist_Zmass_positive_2ndbin->Fill(GENmass2l);
         if(smearing== true) hist_reco_Zmass_positive_2ndbin->Fill(massZ_reconstruct);
        }

        if( 30 <= genLep_pt1 && genLep_pt1 < 40) {
         hist_Zmass_positive_3rdbin->Fill(GENmass2l);
         if(smearing== true) hist_reco_Zmass_positive_3rdbin->Fill(massZ_reconstruct);
        }

        if( 40 <= genLep_pt1 && genLep_pt1 < 50) {
         hist_Zmass_positive_4thbin->Fill(GENmass2l);
         if(smearing== true) hist_reco_Zmass_positive_4thbin->Fill(massZ_reconstruct);
        }

        if( 50 < genLep_pt1 && genLep_pt1 < 60) {
         hist_Zmass_positive_5thbin->Fill(GENmass2l);
         if(smearing== true) hist_reco_Zmass_positive_5thbin->Fill(massZ_reconstruct);
        }

        if( 60 <= genLep_pt1  && genLep_pt1 < 75) {
         hist_Zmass_positive_6thbin->Fill(GENmass2l);
         if(smearing== true) hist_reco_Zmass_positive_6thbin->Fill(massZ_reconstruct);
        }

        if( 75 <= genLep_pt1 && genLep_pt1 < 90) {
         hist_Zmass_positive_7thbin->Fill(GENmass2l);
         if(smearing== true) hist_reco_Zmass_positive_7thbin->Fill(massZ_reconstruct);
        }


        if( 90 <= genLep_pt1 && genLep_pt1 < 110) {
         hist_Zmass_positive_8thbin->Fill(GENmass2l);
         if(smearing== true) hist_reco_Zmass_positive_8thbin->Fill(massZ_reconstruct);
        }

        if( 110 <= genLep_pt1 && genLep_pt1 < 130) {
         hist_Zmass_positive_9thbin->Fill(GENmass2l);
         if(smearing== true) hist_reco_Zmass_positive_9thbin->Fill(massZ_reconstruct);
        }
    
        if( 130 <= genLep_pt1 && genLep_pt1 < 200) {
         hist_Zmass_positive_10thbin->Fill(GENmass2l);
         if(smearing== true) hist_reco_Zmass_positive_10thbin->Fill(massZ_reconstruct);
        }
       ...
       // for negative muons 
        if(0<= genLep_pt2 && genLep_pt2 < 15) {
         ...
         if(smearing== true) hist_reco_Zmass_negative_1stbin->Fill(massZ_reconstruct);
         }

        if(15 <= genLep_pt2  && genLep_pt2 < 30) {
         hist_Zmass_negative_2ndbin->Fill(GENmass2l);
         if(smearing== true) hist_reco_Zmass_negative_2ndbin->Fill(massZ_reconstruct);
        }

        if( 30 <= genLep_pt2 && genLep_pt2 < 40) {
         hist_Zmass_negative_3rdbin->Fill(GENmass2l);
         if(smearing== true) hist_reco_Zmass_negative_3rdbin->Fill(massZ_reconstruct);
        }

        if( 40 <= genLep_pt2 && genLep_pt2 < 50) {
         hist_Zmass_negative_4thbin->Fill(GENmass2l);
         if(smearing== true) hist_reco_Zmass_negative_4thbin->Fill(massZ_reconstruct);
        }

        if( 50 < genLep_pt2 && genLep_pt2 < 60) {
         hist_Zmass_negative_5thbin->Fill(GENmass2l);
         if(smearing== true) hist_reco_Zmass_negative_5thbin->Fill(massZ_reconstruct);
        }

        if( 60 <= genLep_pt2  && genLep_pt2 < 75) {
         hist_Zmass_negative_6thbin->Fill(GENmass2l);
         if(smearing== true) hist_reco_Zmass_negative_6thbin->Fill(massZ_reconstruct);
        }

        if( 75 <= genLep_pt2 && genLep_pt2 < 90) {
         hist_Zmass_negative_7thbin->Fill(GENmass2l);
         if(smearing== true) hist_reco_Zmass_negative_7thbin->Fill(massZ_reconstruct);
        }


        if( 90 <= genLep_pt2 && genLep_pt2 < 110) {
         hist_Zmass_negative_8thbin->Fill(GENmass2l);
         if(smearing== true) hist_reco_Zmass_negative_8thbin->Fill(massZ_reconstruct);
        }

        if( 110 <= genLep_pt2 && genLep_pt2 < 130) {
         hist_Zmass_negative_9thbin->Fill(GENmass2l);
         if(smearing== true) hist_reco_Zmass_negative_9thbin->Fill(massZ_reconstruct);
        }
    
        if( 130 <= genLep_pt2 && genLep_pt2 < 200) {
         hist_Zmass_negative_10thbin->Fill(GENmass2l);
         if(smearing== true) hist_reco_Zmass_negative_10thbin->Fill(massZ_reconstruct);
        }
...
//end of loop of entries   
   ...
   //
    ...
    plotting_hist(hist_reco_Zmass_positive_1stbin,"reco Z mass for 1st pT  bin","reco_Zmass_1stbin_pT_positive", "m(#mu^{+}#mu^{-})");
    plotting_hist(hist_reco_Zmass_positive_2ndbin,"reco Z mass for 2nd pT  bin","reco_Zmass_2ndbin_pT_positive", "m(#mu^{+}#mu^{-})");
    plotting_hist(hist_reco_Zmass_positive_3rdbin,"reco Z mass for 3rd pT  bin","reco_Zmass_3rdbin_pT_positive", "m(#mu^{+}#mu^{-})");
    plotting_hist(hist_reco_Zmass_positive_4thbin,"reco Z mass for 4th pT  bin","reco_Zmass_4thbin_pT_positive", "m(#mu^{+}#mu^{-})");
    plotting_hist(hist_reco_Zmass_positive_5thbin,"reco Z mass for 5th pT  bin","reco_Zmass_5thbin_pT_positive", "m(#mu^{+}#mu^{-})");
    plotting_hist(hist_reco_Zmass_positive_6thbin,"reco Z mass for 6th pT  bin","reco_Zmass_6thbin_pT_positive", "m(#mu^{+}#mu^{-})");
    plotting_hist(hist_reco_Zmass_positive_7thbin,"reco Z mass for 7th pT  bin","reco_Zmass_7thbin_pT_positive", "m(#mu^{+}#mu^{-})");
    plotting_hist(hist_reco_Zmass_positive_8thbin,"reco Z mass for 8th pT  bin","reco_Zmass_8thbin_pT_positive", "m(#mu^{+}#mu^{-})");
    plotting_hist(hist_reco_Zmass_positive_9thbin,"reco Z mass for 9th pT  bin","reco_Zmass_9thbin_pT_positive", "m(#mu^{+}#mu^{-})");
    plotting_hist(hist_reco_Zmass_positive_10thbin,"reco Z mass for 10th pT  bin","reco_Zmass_10thbin_pT_positive", "m(#mu^{+}#mu^{-})");
    
    plotting_hist(hist_reco_Zmass_negative_1stbin,"reco Z mass for 1st pT  bin","reco_Zmass_1stbin_pT_negative", "m(#mu^{+}#mu^{-})");
    plotting_hist(hist_reco_Zmass_negative_2ndbin,"reco Z mass for 2nd pT  bin","reco_Zmass_2ndbin_pT_negative", "m(#mu^{+}#mu^{-})");
    plotting_hist(hist_reco_Zmass_negative_3rdbin,"reco Z mass for 3rd pT  bin","reco_Zmass_3rdbin_pT_negative", "m(#mu^{+}#mu^{-})");
    plotting_hist(hist_reco_Zmass_negative_4thbin,"reco Z mass for 4th pT  bin","reco_Zmass_4thbin_pT_negative", "m(#mu^{+}#mu^{-})");
    plotting_hist(hist_reco_Zmass_negative_5thbin,"reco Z mass for 5th pT  bin","reco_Zmass_5thbin_pT_negative", "m(#mu^{+}#mu^{-})");
    plotting_hist(hist_reco_Zmass_negative_6thbin,"reco Z mass for 6th pT  bin","reco_Zmass_6thbin_pT_negative", "m(#mu^{+}#mu^{-})");
    plotting_hist(hist_reco_Zmass_negative_7thbin,"reco Z mass for 7th pT  bin","reco_Zmass_7thbin_pT_negative", "m(#mu^{+}#mu^{-})");
    plotting_hist(hist_reco_Zmass_negative_8thbin,"reco Z mass for 8th pT  bin","reco_Zmass_8thbin_pT_negative", "m(#mu^{+}#mu^{-})");
    plotting_hist(hist_reco_Zmass_negative_9thbin,"reco Z mass for 9th pT  bin","reco_Zmass_9thbin_pT_negative", "m(#mu^{+}#mu^{-})");
    plotting_hist(hist_reco_Zmass_negative_10thbin,"reco Z mass for 10th pT  bin","reco_Zmass_10thbin_pT_negative", "m(#mu^{+}#mu^{-})");
  ...
  if(analyze_pT==true){   
   mean_sigma_positive[0] =  plotting_fitting_mass_DSCB(hist_Zmass_positive_1stbin,"Zmass_1stbin_pT_fit_positive");
   mean_sigma_positive[1] = plotting_fitting_mass_DSCB(hist_Zmass_positive_2ndbin,"Zmass_2ndbin_pT_fit_positive");
   mean_sigma_positive[2] = plotting_fitting_mass_DSCB(hist_Zmass_positive_3rdbin,"Zmass_3rdbin_pT_fit_positive");
   mean_sigma_positive[3] = plotting_fitting_mass_DSCB(hist_Zmass_positive_4thbin,"Zmass_4thbin_pT_fit_positive");
   mean_sigma_positive[4] = plotting_fitting_mass_DSCB(hist_Zmass_positive_5thbin,"Zmass_5thbin_pT_fit_positive");
   mean_sigma_positive[5] = plotting_fitting_mass_DSCB(hist_Zmass_positive_6thbin,"Zmass_6thbin_pT_fit_positive");
   mean_sigma_positive[6] = plotting_fitting_mass_DSCB(hist_Zmass_positive_7thbin,"Zmass_7thbin_pT_fit_positive");
   mean_sigma_positive[7] = plotting_fitting_mass_DSCB(hist_Zmass_positive_8thbin,"Zmass_8thbin_pT_fit_positive");
   mean_sigma_positive[8] = plotting_fitting_mass_DSCB(hist_Zmass_positive_9thbin,"Zmass_9thbin_pT_fit_positive");
   mean_sigma_positive[9] = plotting_fitting_mass_DSCB(hist_Zmass_positive_10thbin,"Zmass_10thbin_pT_fit_positive");

   mean_sigma_negative[0] =  plotting_fitting_mass_DSCB(hist_Zmass_negative_1stbin,"Zmass_1stbin_pT_fit_negative");
   mean_sigma_negative[1] = plotting_fitting_mass_DSCB(hist_Zmass_negative_2ndbin,"Zmass_2ndbin_pT_fit_negative");
   mean_sigma_negative[2] = plotting_fitting_mass_DSCB(hist_Zmass_negative_3rdbin,"Zmass_3rdbin_pT_fit_negative");
   mean_sigma_negative[3] = plotting_fitting_mass_DSCB(hist_Zmass_negative_4thbin,"Zmass_4thbin_pT_fit_negative");
   mean_sigma_negative[4] = plotting_fitting_mass_DSCB(hist_Zmass_negative_5thbin,"Zmass_5thbin_pT_fit_negative");
   mean_sigma_negative[5] = plotting_fitting_mass_DSCB(hist_Zmass_negative_6thbin,"Zmass_6thbin_pT_fit_negative");
   mean_sigma_negative[6] = plotting_fitting_mass_DSCB(hist_Zmass_negative_7thbin,"Zmass_7thbin_pT_fit_negative");
   mean_sigma_negative[7] = plotting_fitting_mass_DSCB(hist_Zmass_negative_8thbin,"Zmass_8thbin_pT_fit_negative");
   mean_sigma_negative[8] = plotting_fitting_mass_DSCB(hist_Zmass_negative_9thbin,"Zmass_9thbin_pT_fit_negative");
   mean_sigma_negative[9] = plotting_fitting_mass_DSCB(hist_Zmass_negative_10thbin,"Zmass_10thbin_pT_fit_negative");


   mean_sigma_positive_reco[0] =  plotting_fitting_mass_DSCB(hist_reco_Zmass_positive_1stbin,"Zmass reco_1stbin_pT_fit_positive");
   mean_sigma_positive_reco[1] = plotting_fitting_mass_DSCB(hist_reco_Zmass_positive_2ndbin,"Zmass reco_2ndbin_pT_fit_positive");
   mean_sigma_positive_reco[2] = plotting_fitting_mass_DSCB(hist_reco_Zmass_positive_3rdbin,"Zmass reco_3rdbin_pT_fit_positive");
   mean_sigma_positive_reco[3] = plotting_fitting_mass_DSCB(hist_reco_Zmass_positive_4thbin,"Zmass reco_4thbin_pT_fit_positive");
   mean_sigma_positive_reco[4] = plotting_fitting_mass_DSCB(hist_reco_Zmass_positive_5thbin,"Zmass reco_5thbin_pT_fit_positive");
   mean_sigma_positive_reco[5] = plotting_fitting_mass_DSCB(hist_reco_Zmass_positive_6thbin,"Zmass reco_6thbin_pT_fit_positive");
   mean_sigma_positive_reco[6] = plotting_fitting_mass_DSCB(hist_reco_Zmass_positive_7thbin,"Zmass reco_7thbin_pT_fit_positive");
   mean_sigma_positive_reco[7] = plotting_fitting_mass_DSCB(hist_reco_Zmass_positive_8thbin,"Zmass reco_8thbin_pT_fit_positive");
   mean_sigma_positive_reco[8] = plotting_fitting_mass_DSCB(hist_reco_Zmass_positive_9thbin,"Zmass reco_9thbin_pT_fit_positive");
   mean_sigma_positive_reco[9] = plotting_fitting_mass_DSCB(hist_reco_Zmass_positive_10thbin,"Zmass reco_10thbin_pT_fit_positive");

   mean_sigma_negative_reco[0] =  plotting_fitting_mass_DSCB(hist_reco_Zmass_negative_1stbin,"Zmass reco_1stbin_pT_fit_negative");
   mean_sigma_negative_reco[1] = plotting_fitting_mass_DSCB(hist_reco_Zmass_negative_2ndbin,"Zmass reco_2ndbin_pT_fit_negative");
   mean_sigma_negative_reco[2] = plotting_fitting_mass_DSCB(hist_reco_Zmass_negative_3rdbin,"Zmass reco_3rdbin_pT_fit_negative");
   mean_sigma_negative_reco[3] = plotting_fitting_mass_DSCB(hist_reco_Zmass_negative_4thbin,"Zmass reco_4thbin_pT_fit_negative");
   mean_sigma_negative_reco[4] = plotting_fitting_mass_DSCB(hist_reco_Zmass_negative_5thbin,"Zmass reco_5thbin_pT_fit_negative");
   mean_sigma_negative_reco[5] = plotting_fitting_mass_DSCB(hist_reco_Zmass_negative_6thbin,"Zmass reco_6thbin_pT_fit_negative");
   mean_sigma_negative_reco[6] = plotting_fitting_mass_DSCB(hist_reco_Zmass_negative_7thbin,"Zmass reco_7thbin_pT_fit_negative");
   mean_sigma_negative_reco[7] = plotting_fitting_mass_DSCB(hist_reco_Zmass_negative_8thbin,"Zmass reco_8thbin_pT_fit_negative");
   mean_sigma_negative_reco[8] = plotting_fitting_mass_DSCB(hist_reco_Zmass_negative_9thbin,"Zmass reco_9thbin_pT_fit_negative");
   mean_sigma_negative_reco[9] = plotting_fitting_mass_DSCB(hist_reco_Zmass_negative_10thbin,"Zmass reco_10thbin_pT_fit_negative");
   ...
   if(analyze_eta==true){
   mean_sigma_positive_eta[0] =  plotting_fitting_mass_DSCB(hist_Zmass_positive_1st_etabin,"Zmass_1stbin_eta_fit_positive");
   mean_sigma_positive_eta[1] = plotting_fitting_mass_DSCB(hist_Zmass_positive_2nd_etabin,"Zmass_2ndbin_eta_fit_positive");
   mean_sigma_positive_eta[2] = plotting_fitting_mass_DSCB(hist_Zmass_positive_3rd_etabin,"Zmass_3rdbin_eta_fit_positive");
   mean_sigma_positive_eta[3] = plotting_fitting_mass_DSCB(hist_Zmass_positive_4th_etabin,"Zmass_4thbin_eta_fit_positive");
   mean_sigma_positive_eta[4] = plotting_fitting_mass_DSCB(hist_Zmass_positive_5th_etabin,"Zmass_5thbin_eta_fit_positive");
   mean_sigma_positive_eta[5] = plotting_fitting_mass_DSCB(hist_Zmass_positive_6th_etabin,"Zmass_6thbin_eta_fit_positive");
   mean_sigma_positive_eta[6] = plotting_fitting_mass_DSCB(hist_Zmass_positive_7th_etabin,"Zmass_7thbin_eta_fit_positive");
   mean_sigma_positive_eta[7] = plotting_fitting_mass_DSCB(hist_Zmass_positive_8th_etabin,"Zmass_8thbin_eta_fit_positive");
 
   mean_sigma_negative_eta[0] =  plotting_fitting_mass_DSCB(hist_Zmass_negative_1st_etabin,"Zmass_1stbin_eta_fit_negative");
   mean_sigma_negative_eta[1] = plotting_fitting_mass_DSCB(hist_Zmass_negative_2nd_etabin,"Zmass_2ndbin_eta_fit_negative");
   mean_sigma_negative_eta[2] = plotting_fitting_mass_DSCB(hist_Zmass_negative_3rd_etabin,"Zmass_3rdbin_eta_fit_negative");
   mean_sigma_negative_eta[3] = plotting_fitting_mass_DSCB(hist_Zmass_negative_4th_etabin,"Zmass_4thbin_eta_fit_negative");
   mean_sigma_negative_eta[4] = plotting_fitting_mass_DSCB(hist_Zmass_negative_5th_etabin,"Zmass_5thbin_eta_fit_negative");
   mean_sigma_negative_eta[5] = plotting_fitting_mass_DSCB(hist_Zmass_negative_6th_etabin,"Zmass_6thbin_eta_fit_negative");
   mean_sigma_negative_eta[6] = plotting_fitting_mass_DSCB(hist_Zmass_negative_7th_etabin,"Zmass_7thbin_eta_fit_negative");
   mean_sigma_negative_eta[7] = plotting_fitting_mass_DSCB(hist_Zmass_negative_8th_etabin,"Zmass_8thbin_eta_fit_negative");
   ...
   if(analyze_phi==true){
   mean_sigma_positive_phi[0] =  plotting_fitting_mass_BW(hist_Zmass_positive_1st_phibin,"Zmass_1stbin_phi_fit_positive");
   mean_sigma_positive_phi[1] = plotting_fitting_mass_BW(hist_Zmass_positive_2nd_phibin,"Zmass_2ndbin_phi_fit_positive");
   mean_sigma_positive_phi[2] = plotting_fitting_mass_BW(hist_Zmass_positive_3rd_phibin,"Zmass_3rdbin_phi_fit_positive");
   mean_sigma_positive_phi[3] = plotting_fitting_mass_BW(hist_Zmass_positive_4th_phibin,"Zmass_4thbin_phi_fit_positive");
   mean_sigma_positive_phi[4] = plotting_fitting_mass_BW(hist_Zmass_positive_5th_phibin,"Zmass_5thbin_phi_fit_positive");
   mean_sigma_positive_phi[5] = plotting_fitting_mass_BW(hist_Zmass_positive_6th_phibin,"Zmass_6thbin_phi_fit_positive");
   mean_sigma_positive_phi[6] = plotting_fitting_mass_BW(hist_Zmass_positive_7th_phibin,"Zmass_7thbin_phi_fit_positive");
   mean_sigma_positive_phi[7] = plotting_fitting_mass_BW(hist_Zmass_positive_8th_phibin,"Zmass_8thbin_phi_fit_positive");
 
   mean_sigma_negative_phi[0] =  plotting_fitting_mass_BW(hist_Zmass_negative_1st_phibin,"Zmass_1stbin_phi_fit_negative");
   mean_sigma_negative_phi[1] = plotting_fitting_mass_BW(hist_Zmass_negative_2nd_phibin,"Zmass_2ndbin_phi_fit_negative");
   mean_sigma_negative_phi[2] = plotting_fitting_mass_BW(hist_Zmass_negative_3rd_phibin,"Zmass_3rdbin_phi_fit_negative");
   mean_sigma_negative_phi[3] = plotting_fitting_mass_BW(hist_Zmass_negative_4th_phibin,"Zmass_4thbin_phi_fit_negative");
   mean_sigma_negative_phi[4] = plotting_fitting_mass_BW(hist_Zmass_negative_5th_phibin,"Zmass_5thbin_phi_fit_negative");
   mean_sigma_negative_phi[5] = plotting_fitting_mass_BW(hist_Zmass_negative_6th_phibin,"Zmass_6thbin_phi_fit_negative");
   mean_sigma_negative_phi[6] = plotting_fitting_mass_BW(hist_Zmass_negative_7th_phibin,"Zmass_7thbin_phi_fit_negative");
   mean_sigma_negative_phi[7] = plotting_fitting_mass_BW(hist_Zmass_negative_8th_phibin,"Zmass_8thbin_phi_fit_negative");
   ...
   ofstream myfile;
       ...
       mean_positive_reco[i] = mean_sigma_positive_reco[i].first;
       sigma_positive_reco[i] = mean_sigma_positive_reco[i].second;
       
       diff_Zmass_positive_gen_reco[i] = (mean_positive_reco[i] - mean_positive[i]) / mean_positive[i] ; 
      ...
      // sigma[i]<<std::endl;
       ...
       sigma_negative[i] = mean_sigma_negative[i].second;
        mean_negative_reco[i] = mean_sigma_negative_reco[i].first;
       sigma_negative_reco[i] = mean_sigma_negative_reco[i].second;
       myfile<<i<<"\t \t "<<mean_negative[i]<<"\t\t  "<<sigma_negative[i]<<std::endl; 
       diff_Zmass_negative_gen_reco[i] = (mean_negative_reco[i] - mean_negative[i]) / mean_negative[i] ; 
      // sigma[i]<<std::endl;
      } 
     }
       if(analyze_eta==true){
