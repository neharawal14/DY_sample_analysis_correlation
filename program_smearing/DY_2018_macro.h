...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   public:
    ...
    TString saving_path = "/afs/cern.ch/user/n/nrawal/work/DY_analysis/program_smearing/plots_pt_tmp/";
    ...
    std::pair<double,double> mean_sigma_positive_reco[10];
    std::pair<double,double> mean_sigma_negative_reco[10];
    ...
    double mean_positive_reco[10];
    double sigma_positive_reco[10];
    double mean_negative_reco[10];
    double sigma_negative_reco[10];
 ...
 void DY_2018_macro :: graph_mean_pT_reco(){
   TGraphErrors *gr_positive_reco = new TGraphErrors(10, pT_list,mean_positive_reco, 0,sigma_positive_reco);
   // TGraph *gr = new TGraph(10,pT_list,mean);
   ...
   TGraphErrors *gr_negative_reco = new TGraphErrors(10, pT_list,mean_negative_reco, 0,sigma_negative_reco);
   // TGraph *gr = new TGraph(10,pT_list,mean);
 ...
 void DY_2018_macro :: graph_diff_Zmass_gen_reco(){
   TGraph *gr_diff_gen_reco_positive = new TGraph(10, pT_list,diff_Zmass_positive_gen_reco);
   // TGraph *gr = new TGraph(10,pT_list,mean);
   ...
   TGraph *gr_diff_gen_reco_negative = new TGraph(10, pT_list,diff_Zmass_negative_gen_reco);
   // TGraph *gr = new TGraph(10,pT_list,mean);
...
//    histo.statOn(xframe);
   ...
   //  TF1* func = (TF1*) model->asTF( RooArgList(*m4mu), RooArgList(*Mean,*Sigma,*AlphaL,*ExpL,*AlphaR, *ExpR) );
/*
   auto c1 = new TCanvas("c1", "fit residual simple");
   //h1->GetXaxis()->SetTitle("x");
   c1->Clear(); // Fit does not draw into correct pad
   auto rp1 = new TRatioPlot(hist_fit);
   rp1->Draw();
   rp1->GetLowerRefYaxis()->SetTitle("ratio");
   rp1->GetUpperRefYaxis()->SetTitle("entries");
   c1->Update();
   c1->SaveAs((saving_path+ saving_name + "DSCB_new.pdf"));*/
    gStyle->SetOptStat();
